                    ...
                    <div class="col-md-7">
                        <div class="card-body">
                            <div class="brand-wrapper">
                                <img src="{{ asset('template/images') }}/mik.png" alt="logo" class="logo">
                            </div>
                            ...
                            <form action="" method="POST">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="email" id="email" class="form-control" value="{{ old('email') }}" placeholder="User Router">
                                    @error('user')
